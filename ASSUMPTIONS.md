...
File: ASSUMPTIONS.md
Title: Assumptions (Top-Level Pointer)
Purpose: Top-level pointer to the assumption register
...
Failure Behaviour: Undocumented assumptions are a defect
...
See `project-control/ASSUMPTION_REGISTER.md` for the authoritative assumption register.
